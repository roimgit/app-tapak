  ...
  return (
    <div className="bg-white rounded-[18px] p-6 sm:p-7 border border-slate-200 shadow-xs">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-3.5 rounded-[10px] bg-slate-50 border border-slate-200">
          <div>
        ...
        <div className="flex items-center justify-between p-3.5 rounded-[10px] bg-blue-50/50 border border-blue-100">
          <div>
        ...
        <div className="flex items-center justify-between p-3.5 rounded-[10px] bg-amber-50/60 border border-amber-200">
          <div>
      ...
      <div className="mt-6 pt-5 border-t border-slate-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-gradient-to-r from-blue-50/50 to-transparent p-4 rounded-[12px]">
        <div>
