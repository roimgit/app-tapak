  ...
  return (
    <div className="w-full h-full overflow-y-auto p-4 sm:p-6 bg-[#F3F6FB] animate-in fade-in slide-in-from-left-4 duration-200">
      ...
      <div className="bg-white rounded-[18px] p-4 sm:p-5 border border-[#E2E8F0] shadow-2xs mb-8">
        ...
        {!isAuthenticated && (
          <div className="mb-3 p-2 rounded-[8px] bg-blue-50/70 border border-blue-100 flex items-center gap-1.5 text-[11px] text-[#3D77EE] font-semibold">
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-[#25D366] hover:bg-[#1EBE5D] text-white font-bold text-xs sm:text-sm rounded-[10px] shadow-sm transition-all active:scale-98 cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-[#3D77EE] hover:bg-[#2B55AB] text-white font-bold text-xs sm:text-sm rounded-[10px] transition-colors cursor-pointer active:scale-98"
          >
          ...
          <button
            type="button"
            onClick={onBack}
            className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs rounded-[10px] transition-colors cursor-pointer"
          >
