  ...
  return (
    <section className="py-16 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
        ...
        >
          <span>{t("feat.explore_all", "Explore Semua Properti")}</span>
