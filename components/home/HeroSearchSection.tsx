        ...
        <div className="mt-4 max-w-4xl mx-auto bg-white p-3 sm:p-4 rounded-[18px] shadow-xl shadow-blue-500/10 border border-slate-200">
          <form action="/explore" method="GET" className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
            <div className="md:col-span-5 flex items-center gap-3 px-3 py-2.5 bg-slate-50 hover:bg-slate-100/80 rounded-[10px] border border-slate-200 transition-colors">
              ...
              <div className="text-left w-full">
                ...
                <input
                  type="text"
                  name="q"
                  placeholder="Contoh: SCBD, Kebayoran, BSD City..."
            ...
            <div className="md:col-span-3">
              <button
                type="submit"
                className="w-full h-full min-h-[50px] flex items-center justify-center gap-2 px-6 py-3 bg-[#3D77EE] hover:bg-[#2B55AB] text-white font-bold text-sm rounded-[10px] shadow-md shadow-blue-500/25 transition-all active:scale-[0.98]"
              >
          ...
          <div className="mt-3 pt-3 border-t border-slate-100 flex items-center flex-wrap gap-2 text-xs text-[#687280]">
            <span className="font-semibold text-slate-500">Pencarian Populer:</span>
